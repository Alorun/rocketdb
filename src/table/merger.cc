...
class MergingIterator : public Iterator {
    ...
    private:
        ...
        int n_;                         // The num of children arrays
        IteratorWrapper* current_;      // The iterator returned to last time 
        Direction direction_;           // Current traversal direction si forward or backward
};
